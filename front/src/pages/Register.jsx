...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            const payload = {
                password: password,
                identityKey: signalService.arrayBufferToBase64(keys.identityKeyPair.pubKey),
                signedPreKey: signalService.arrayBufferToBase64(keys.signedPreKey.keyPair.pubKey),
                signedPreKeyId: keys.signedPreKey.keyId,
                signedPreKeySignature: signalService.arrayBufferToBase64(keys.signedPreKey.signature),
    ...
    return (
        <div style={{ maxWidth: '400px', margin: '2rem auto', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px' }}>
            ...
            <form onSubmit={handleRegister}>
                ...
                <button type="submit" disabled={loading} style={{ width: '100%', padding: '0.5rem', background: '#007bff', color: 'white', border: 'none', borderRadius: '4px' }}>
